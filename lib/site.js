...
import SiteJetPackModule from './site.jetpack-module';
...
class Site {
	...
	/**
	 * Create a `SiteJetPack` instance
	 *
	 * @param {String} id - jetpack module id
	 * @return {SiteJetPack} SiteJetPack instance
	 */
	jetpackModule( id ) {
		return new SiteJetPackModule( id, this._id, this.wpcom );
	}
