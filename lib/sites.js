...
Sites.prototype.get = function(params, fn){
  ...
  this.wpcom.sendRequest('sites.get', { site: this._id }, params, fn);
};
...
Sites.prototype.posts = function(params, fn){
  ...
  this.wpcom.sendRequest('sites.posts.get', { site: this._id }, params, fn);
};
...
Sites.prototype.medias = function(params, fn){
  ...
  this.wpcom.sendRequest('sites.medias.get', { site: this._id }, params, fn);
};
